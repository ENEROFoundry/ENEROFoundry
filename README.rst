...
.. list-table::
   ...
   * - Community
     - |badge_contributions| |badge_contributors| |badge_discussions| |badge_repo_counts|
...
| The authorship and license of each file is document using `REUSE <https://reuse.software/>`_:
