...
Both semantic and calendaric versioning format have advantages. Choose one of the two standards for publication. More information on semantic versus calendaric versioning can be found here e.g.: 
https://glinteco.com/en/post/understanding-semver-vs-calver-making-the-right-choice-for-your-project/
The annotation owl:versionInfo identifies the version and versionIRI identifies the resource
