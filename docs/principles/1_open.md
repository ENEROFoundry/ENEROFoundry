...
- OEOF ontologies MAY use one of the following suitable open licenses:
...
- OEOF ontologies MAY but SHOULD NOT use the [Creative Commons Attribution 4.0 International (CC-BY-4.0)](https://creativecommons.org/licenses/by/4.0/legalcode.en) (see [discussion](https://opensource.stackexchange.com/questions/9242/why-does-creative-commons-recommend-not-using-cc-by-licenses-for-software)).
...
- Any OEOF ontology reusing individual terms from another ontology SHOULD
