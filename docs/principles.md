...
## Definition
The scope of an ontology is the extent of the domain or subject it intends to cover. The ontology must have a clearly specified scope and content that adheres to that scope.
